...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الحسابات البنكية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل
                حساب بنكي ( {{ $bank_account->name_ar }} )</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('bank_accounts.index') }}">رجوع</a>
                        </div>
                    </div><br>
                    {!! Form::model($bank_account,['route' => ['bank_accounts.update' , $bank_account->id], 'method' => 'put','files' => true]) !!}
