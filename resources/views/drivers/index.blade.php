                            ...
                            @foreach ($drivers as $key => $driver)
                                <tr>
                                    ...
                                    @if($driver->is_active == 1)
                                        ...
                                        <td>
                                            {!! Form::model($driver,['route' => ['drivers.status' , $driver->id], 'method' => 'put']) !!}
                                    ...
                                    <td>
                                        <a href="{{ route('drivers.edit', $driver->id) }}" class="btn btn-sm btn-info"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    {{ Form::open(['route' => 'drivers.store', 'class' => 'parsley-style-1', 'method' => 'post', 'files' => true]) }}
                    @csrf
