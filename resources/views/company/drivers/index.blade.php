            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-sm-1 col-md-2">
                        ...
                        <a class="btn btn-primary modal-effect" href="#modaldemo8" data-toggle="modal">اضافة سائق</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($drivers as $key => $driver)
                                <tr>
                                    ...
                                    @if($driver->is_active == 1)
                                        ...
                                        <td>
                                            {!! Form::model($driver,['route' => ['company.drivers.status' , $driver->id], 'method' => 'put']) !!}
                                    ...
                                    <td>
                                        <a href="{{ url('company/drivers/'. $driver->id . '/edit') }}" class="btn btn-sm btn-info"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    {{ Form::open(['route' => 'company.drivers.store', 'class' => 'parsley-style-1', 'method' => 'post', 'files' => true]) }}
                    @csrf
