...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تليفونات الشركة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-sm-1 col-md-2">
                        ...
                        <a class="btn btn-primary modal-effect" href="#modaldemo8" data-toggle="modal">اضافة تليفون</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($phones as $key => $phone)
                                <tr>
                                    ...
                                    @if($phone->is_active == 1)
                                        ...
                                        <td>
                                            {!! Form::model($phone,['route' => ['phones.status' , $phone->id], 'method' => 'put']) !!}
                                    ...
                                    <td>
                                        <a href="{{ route('phones.edit', $phone->id) }}" class="btn btn-sm btn-info"
                                           title="تعديل"> <i class="las la-pen"></i> تعديل</a>
                                        <button class="btn btn-danger btn-sm " data-id="{{ $phone->id }}"
                                                data-name_ar="{{ $phone->phone }}" data-toggle="modal"
