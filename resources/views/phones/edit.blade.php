...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تليفونات الشركة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل
                الرقم ( {{ $phone->phone }} )</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('phones.index') }}">رجوع</a>
                        </div>
                    </div><br>
